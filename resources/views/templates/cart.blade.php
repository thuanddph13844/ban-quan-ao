            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-light table-borderless table-hover text-center mb-0">
                    ...
                    @foreach($newcart -> products as $item)
                        <tr>
                            <td class="align-middle"><img src="{{ $item['proInfor'] -> image?''.Storage::url($item['proInfor']->image):'http://placehold.it/100x100' }}" alt="" style="width: 50px;"> {{$item['proInfor']->name}}</td>
                            <td class="align-middle">{{$item['proInfor']->price}}</td>
